...
import { PropertyTenanciesOverview } from './components/dashboard/property';
import DocsLayout from './components/docs/DocsLayout';
import GuestGuard from './components/GuestGuard';
import LoadingScreen from './components/LoadingScreen';
import MainLayout from './components/MainLayout';
import BookEngineer from './pages/BookEngineer';
import BookHandyman from './pages/BookHandyman';
import BookCertificate from './pages/BookCertificate';
...
const Tenancies = Loadable(lazy(() => import('./pages/Tenancies')));
const TenancyListResults = Loadable(lazy(() => import('./components/dashboard/property/TenancyListResults')));
// Docs pages
...
const PropertyCreateSame = Loadable(lazy(() => import('./pages/dashboard/PropertyCreateSame')));
const TenancyCreate = Loadable(lazy(() => import('./pages/dashboard/TenancyCreate')));
...
const routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '/property/TenancyListResults',
        element: <TenancyListResults />
      },
     ...
     /*  {
      ...
      },
      {
        ...
        children: [
          {
            path: '/',
            element: <BookHandyman />
          }
        ]
      },
      {
        path: 'bookcertificate',
        children: [
          {
            path: '/',
            element: <BookCertificate />
          }
        ]
      },
      {
        path: 'insurancequotes',
        children: [
          {
            path: '/',
            element: <InsuranceQuotes />
          }
        ]
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'tenancy',
            element: <TenancyCreate />
          },
          
          {
            path: 'same',
            element: <PropertyCreateSame />
          },
          {
            path: 'tenant',
